...
const Login = (props: Props) => {
  ...
  return (
    <section className="relative flex flex-wrap lg:h-screen lg:items-center">
        ...
        <form
          ...
          <div className="flex items-center justify-between">
            <p className="text-sm text-gray-500">
              No account?
              <a className="cursor-pointer underline" onClick={handleToggle}>
                Sign up
              </a>
            </p>

            <Button type="submit" disabled={isLoading} size="wide">
              {isLoading && (
      ...
      <div className="relative flex h-32 w-1/2 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
        <img
          alt="Welcome"
